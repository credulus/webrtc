        ...
        function clearSession() {
            ...
            if (connection.isInitiator) {
                ...
                if (connection.autoCloseEntireSession) {
                    ...
                    console.log('close entire session'+connection.userid);
    ...
    function setDefaults(connection) {
        ...
        iceServers.push({
         ...
         window.turnserversDotComAPI.iceServers(function(data) {
           ...
           for(i in data ){
               iceServers.push({url:data[i].url, credential:data[i].credential})
           }
           console.log('iceServers - start');
           console.log(iceServers);
           console.log('iceServers - end');
        });
